...
##'     }
##'
##'     \item{\code{as_proxy}:   Logical, indicating if a list of \code{\link{mdb_proxy}} objects shold be returned.
##'     }
##'
...
##'     }
##'
##'     \item{\code{b}:   A key to comare with b (string or raw)
##'     }
##'   }
##'
##'   \emph{Value}:
...
##'     }
##'
##'     \item{\code{b}:   A data item to comare with b (string or raw)
##'     }
##'   }
##'
##'   \emph{Value}:
